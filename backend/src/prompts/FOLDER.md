<!-- INPUT: Prompt 管理目录结构与输出规范索引（含详情解读分区标签、紧凑摘要上下文变更、CBT 日常建议约束与本我页面提示词目录）。 -->
<!-- OUTPUT: prompts 架构摘要与文件清单（含详情解读标签化结构、合盘成长焦点字段调整、CBT 独立统计 Prompt 与本我页面提示词目录）。 -->
<!-- POS: Prompt 目录索引文档（含本我页面提示词目录）；若更新此文件，务必更新本头注释与所属文件夹的 FOLDER.md。 -->
...
- self-page/｜地位：本我页面提示词目录｜功能：Big3/12维/6维/附录提示词。
...
- 新增日运维度/宜忌/时间窗口/周趋势/相位矩阵/星象解读 Prompt，并调整行运小行星与宫主星输出结构。
